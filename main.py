...
def main(dataFile,badWordsFileName,specify_cols,head,rows_at_chunk):
...
if __name__=="__main__":
    ...
    specify_cols=[0, 2, 6]
    #rar data file
    dataFile=r'C:\Users\Khale\Downloads\filter_words\40k.rar'
    ...
    while(rows_at_chunk<=150000):
        main(dataFile,badWordsFileName,specify_cols,head,rows_at_chunk)
        rows_at_chunk+=10000